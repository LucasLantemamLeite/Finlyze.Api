...
using Finlyze.Domain.ValueObjects.FinancialTransactionObjects;

namespace Finlyze.Domain.Entities.FinancialTransactionEntity;

public sealed class FinancialTransaction : EntityInt
{
