...
public class FakeCreateAdminUserAccountHandler : ICreateAdminUserAccountHandler
{
    ...
    public FakeCreateAdminUserAccountHandler(List<UserAccount> users)
    {
        _users = users;
    ...
    public async Task<ResultHandler<UserAccount>> Handle(CreateUserAccountCommand command)
    {
        ...
        return ResultHandler<UserAccount>.Ok("Conta do usuário admin criado com sucesso.", userAccount);
    }
}
